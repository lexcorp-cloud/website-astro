...
export const tools = [
  ...
  },
  {
    ...
    tagline: 'Registrar · Expiry · Locks',
    category: 'DNS',
    description:
      'Look up who a domain is registered with, when it expires, and whether the transfer and delete locks that prevent hijacking are actually switched on.',
    status: 'live',
  },
  {
    slug: 'np-domain-check',
    href: '/tools/np-domain-check',
    icon: 'pin',
    short: '.np Domains',
    name: '.np Domain Checker',
    tagline: 'Nepal · Availability',
    category: 'DNS',
    description:
      'Check whether a .com.np or .np domain is already taken, using DNS delegation — because Nepal’s registry publishes no WHOIS or RDAP service at all.',
    status: 'live',
  },
  {
    slug: 'dns-propagation',
    href: '/tools/dns-propagation',
    icon: 'route',
    short: 'Propagation',
    name: 'DNS Propagation Checker',
    tagline: 'Multi-resolver · TTL',
    category: 'DNS',
    description:
      'Query a record against independent public resolvers at once to see whether a DNS change has taken effect everywhere or is still cached somewhere.',
    status: 'live',
  },
  {
    slug: 'reverse-dns',
    ...
    tagline: 'PTR · rDNS · Mail',
    category: 'Network',
    description:
      'Find the PTR record behind an IPv4 or IPv6 address, and check the forward-confirmed match that mail servers require before they will trust a sender.',
    status: 'live',
  },
  {
    slug: 'text-diff',
    ...
    tagline: 'Line · Word · Patch',
    category: 'Developer',
    description:
      'Compare two blocks of text or config and see exactly which lines were added, removed or changed, with a unified patch you can copy.',
    status: 'live',
  },
  {
    slug: 'qr-generator',
    ...
    tagline: 'Size - Error correction - Download',
    category: 'Developer',
    description:
      'Generate QR codes from text or URLs with configurable size, error-correction level, and colours. Download as PNG or SVG.',
    status: 'live',
  },
  {
    ...
    tagline: 'WebP - JPEG - PNG - Drag-drop',
    category: 'Developer',
    description:
      'Compress images in your browser - no uploads. Choose format, quality and max dimensions. See before/after sizes.',
    status: 'live',
  },
  {
    ...
    tagline: 'iOS - PWA - Icon sizes',
    category: 'Developer',
    description:
      'Generate favicons from an image or text monogram. Output every standard size plus manifest and HTML snippets.',
    status: 'live',
  },
  {
    slug: 'pdf-tools',
    ...
    tagline: 'Merge - Split - Page range',
    category: 'Developer',
    description:
      'Merge multiple PDFs or split pages locally in your browser. No uploads, no server required.',
    status: 'live',
  },
  {
    ...
    tagline: 'GFM - Live preview - Sanitised',
    category: 'Developer',
    description:
      'Live markdown editor with GitHub-Flavored Markdown, word count, and copy-to-clipboard HTML. Output is sanitised.',
    status: 'live',
  },
  {
    ...
    tagline: 'AA - AAA - Accessible colours',
    category: 'Developer',
    description:
      'Check if a colour pair meets WCAG accessibility standards. Get a verdict for AA and AAA levels and suggestions for fixes.',
    status: 'live',
  },
  {
